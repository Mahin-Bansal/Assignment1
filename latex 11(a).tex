...
\begin{align}
a + (m-1)\left(\frac{a_m - a_n}{m-n}\right) = a_m\\
a = a_m - (m-1)\left(\frac{a_m - a_n}{m-n}\right)
\end{align}
...
\begin{align}
S_n = \left(\frac{n}{2}\right)\left(2a+(n-1)d\right)
\end{align} \\
So, sum of A.P till 8$^{th}$ term is 
\begin{align}
S_8 &=\left(\frac{8}{2}\right)(2(10)+(8-1)4\\
S_8 &= 4(20+28)\\
S_8 &= 192
\end{align} 
\end{document}
